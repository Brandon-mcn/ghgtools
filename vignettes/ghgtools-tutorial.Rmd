...
In order to consolidate emissions data across multiple greenhouse gasses, we need to select global warming potentials (GWPs). You can learn more about different values of global warming potentials by follwoing [this link](https://www.epa.gov/ghgemissions/understanding-global-warming-potentials). The general recommendation is to follow the UNFCCC guidelines, which require the use of GWP values from the IPCC's Fifth Assessment Report (AR5).
