...
initiate <- function(GWP){
  ...
  fwrite(EFL_CO2e, "Input_Data/EFL.csv")
  fwrite(ActivityData, "Input_Data/ActivityData.csv")
  fwrite(AssetPortfolio, "Input_Data/AssetPortfolio.csv")
...
ghg_inventory <- function(){
  ...
  EFL_CO2e <- fread("Input_Data/EFL.csv")
  ...
  AssetPortfolio <- fread("Input_Data/AssetPortfolio.csv")
  ActivityData <- fread("Input_Data/ActivityData.csv")
  ...
  fwrite(GHGrawdata, "Output_Data/GHGrawdata.csv")
